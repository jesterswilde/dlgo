...
from dlgo.data.parralel_proccesor import GoDataProcessor
from dlgo.encoder.oneplane import OnePlaneEncoder
...
generator = processor.load_go_data(
    'train', num_games, use_generator=True)  # <3>
